                ...
                match lowered_value.is_literal() {
                    true => {
                        ...
                        Ok(match (*op, lowered_value.clone()) {
                            ...
                            _ => panic!("Unsupported unary operation: {:?} {:?}", op, lowered_value),
                        })
                    }
                    false => {
...
mod tests {
    ...
    #[case(BinaryOp::Add, Expr::LongReal(2.0), Expr::LongReal(3.0), Expr::LongReal(5.0))]
    #[case(BinaryOp::Add, Expr::LongReal(2.0), Expr::Integer(3), Expr::LongReal(5.0))]
    #[case(BinaryOp::Add, Expr::Integer(2), Expr::LongReal(3.0), Expr::LongReal(5.0))]
    ...
    #[case(BinaryOp::Sub, Expr::LongReal(5.0), Expr::LongReal(3.0), Expr::LongReal(2.0))]
    #[case(BinaryOp::Sub, Expr::LongReal(5.0), Expr::Integer(3), Expr::LongReal(2.0))]
    #[case(BinaryOp::Sub, Expr::Integer(5), Expr::LongReal(3.0), Expr::LongReal(2.0))]
    ...
    #[case(BinaryOp::Mul, Expr::LongReal(2.0), Expr::LongReal(3.0), Expr::LongReal(6.0))]
    #[case(BinaryOp::Mul, Expr::LongReal(2.0), Expr::Integer(3), Expr::LongReal(6.0))]
    #[case(BinaryOp::Mul, Expr::Integer(2), Expr::LongReal(3.0), Expr::LongReal(6.0))]
    ...
    #[case(BinaryOp::Div, Expr::LongReal(6.0), Expr::LongReal(3.0), Expr::LongReal(2.0))]
    #[case(BinaryOp::Div, Expr::LongReal(6.0), Expr::Integer(3), Expr::LongReal(2.0))]
    #[case(BinaryOp::Div, Expr::Integer(6), Expr::LongReal(3.0), Expr::LongReal(2.0))]
    ...
    #[case(BinaryOp::And, Expr::Boolean(true), Expr::Boolean(false), Expr::Boolean(false))]
    #[case(BinaryOp::Or, Expr::Boolean(true), Expr::Boolean(false), Expr::Boolean(true))]
    ...
    #[case(BinaryOp::Eq, Expr::LongReal(5.0), Expr::LongReal(5.0), Expr::Boolean(true))]
    #[case(BinaryOp::Eq, Expr::LongReal(5.0), Expr::LongReal(3.0), Expr::Boolean(false))]
    #[case(BinaryOp::Eq, Expr::Boolean(true), Expr::Boolean(true), Expr::Boolean(true))]
    #[case(BinaryOp::Eq, Expr::Boolean(true), Expr::Boolean(false), Expr::Boolean(false))]
    ...
    fn test_binary(#[case] op: BinaryOp, #[case] left: Expr, #[case] right: Expr, #[case] expected: Expr) {
    ...
    fn test_binary_panic(#[case] op: BinaryOp, #[case] left: Expr, #[case] right: Expr) {
        ...
        assert!(err_msg.contains("Division by zero") || err_msg.contains("Cannot compare different types for equality"));
    }
}
